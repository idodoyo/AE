...
#define HS_PI 3.1415926535897932384626433832795028841971
...
public:
	...
	virtual IGraphicProtocol * GraphicWithIdentifier( HSString tIdentifier ) = 0;
...
public:
	HSInt Count();
	IGraphicProtocol * GraphicWithIndex( HSInt tIndex, HSBool tForceShowAll = HSFalse );
...
static HSDouble DegreeToAngle( HSDouble tDegree )
{
	return tDegree * 180 / HS_PI;
}

static HSDouble AngleToDegree( HSDouble tAngle )
{
	return tAngle * HS_PI / 180.0;
}