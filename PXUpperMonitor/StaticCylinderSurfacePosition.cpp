...
CStaticCylinderSurfacePosition::CStaticCylinderSurfacePosition()
{			
	mBeginYValue = 1000;
	mTotalYValue = 1000;	
	mYDirection = -1;
...
// CStaticCylinderSurfacePosition message handlers

void CStaticCylinderSurfacePosition::ResizeWave()
{
...
void CStaticCylinderSurfacePosition::Draw( CDC *pDC )
{
	CRect tRect;
...
bool CStaticCylinderSurfacePosition::DrawTemplate( CDC *pMemDC, CRect &tRect )
{	
	WaitForSingleObject( mMutex, INFINITE );
