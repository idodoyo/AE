...
/*************************************************
  Function:		SetParam	
  Description:	Set argment when > 0, or don't change.
  Input:		tDeviceNum -- Device Number
				tSampleRate -- sample rate
				tTrigerVoltage -- triger voltage for acquisition data.
  Output:		None
  Return:		None
  Author:		Guo Dengjia
  Date :		2014-09-17
...
/*************************************************
  Function:		GetDevice	
  Description:	used for CDeviceManager to Scan devices.
  Input:		pIndexManager -- used for the card.
				pFileObserver -- used for the card.				
  Output:		pDevices -- keep the new found devices.
...
/*************************************************
  Function:		GetDevice	
  Description:	used for CDeviceManager to review data file.
  Input:		tIdentifier -- card identifier.
				tVersion -- data file version.			
				tDeviceSavePos -- config info to load from data file.
				tChannels -- channels used to acquisition.
				pIndexManager -- used for the card.
				pFileObserver -- used for the card.
  Output:		pDevices -- keep the new matched devices.
  Return:		whether the Identifer match the kind of card.
  Author:		Guo Dengjia
  Date :		2014-09-17
  Last Time Modify:  None
**************************************************/	
HSBool CAdPCIHandler::GetDevice( DEVICE_CH_IDENTIFIER tIdentifier, HSUInt tVersion, HSInt64 tDeviceSavePos, vector< HSInt > &tChannels, vector< IDataHandler * > *pDevices, CIndexManager *pIndexManager, CFileObserver *pFileObserver )
{	
...
/*************************************************
  Function:		Start	
  Description:	start to aquisition data.
  Input:		None
  Output:		None
  Return:		result.
  Author:		Guo Dengjia
...
HSBool CAdPCIHandler::Start()
{
	...
	/* data reset to acquisition data. */
...
/*************************************************
  Function:		Pause	
  Description:	Pause aquisition data.
  Input:		None
  Output:		None
  Return:		None.
  Author:		Guo Dengjia
...
/*************************************************
  Function:		Stop	
  Description:	Stop aquisition data.
  Input:		None
  Output:		None
  Return:		None.
  Author:		Guo Dengjia
...
/*************************************************
  Function:		ListBuffer	
  Description:	Get the saving data buffer.
  Input:		None
  Output:		None
  Return:		result.
  Author:		Guo Dengjia
...
/*************************************************
  Function:		SamplesInFrame	
  Description:	Get the Sample number in one frame for some/one channel.
  Input:		tChannelIdentifier -- specified the channels.
  Output:		None
  Return:		result.
  Author:		Guo Dengjia
  Date :		2014-09-17
...
/*************************************************
  ...
  Description:	get the data from the original buffer, which save in some way like 12341234.
  Input:		tChannelIdentifier -- specified the channels.
				pSrcBuf -- source buffer
				tOffset -- sample offset from the source buffer
				tSamples -- total sample to get.
  Output:		pDestBuf -- keep the result
  Return:		the number of samples got.
  Author:		Guo Dengjia
  Date :		2014-09-17
  Last Time Modify:  None
**************************************************/	
...
/*************************************************
  Function:		EffectiveTest	
  Description:	Used to Discard some data, maybe useless.
  Input:		pBuffer -- data to judge				
  Output:		None
  Return:		result.
  Author:		Guo Dengjia
  Date :		2014-09-17
...
/*************************************************
  ...
  Description:	Thread function used for file and data thread, which with different ID.
...
/*************************************************
  Function:		BufChangeEvent	
  Description:	used for the card to notify acquisitoned enough data.
  Input:		None.				
  Output:		None
  Return:		None.
  Author:		Guo Dengjia
...
/*************************************************
  Function:		OverrunEvent	
  Description:	used for the card to notify some data missed.
  Input:		None.				
  Output:		None
  Return:		None.
  Author:		Guo Dengjia
...
/*************************************************
  ...
  Description:	used for the card to notify going to stop acquisition data.
  Input:		None.				
  Output:		None
  Return:		None.
  Author:		Guo Dengjia
